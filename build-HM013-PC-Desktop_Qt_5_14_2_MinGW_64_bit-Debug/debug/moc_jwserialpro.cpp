...
#include <memory>
#include "../../HM013-PC/jwserialpro.h"
...
void jwSerialPro::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<jwSerialPro *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (jwSerialPro::*)(QString );
        ...
        {
            using _t = void (jwSerialPro::*)(bool );
        ...
        {
            using _t = void (jwSerialPro::*)(QByteArray );
...
QT_INIT_METAOBJECT const QMetaObject jwSerialPro::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_jwSerialPro.data,
    qt_meta_data_jwSerialPro,
    qt_static_metacall,
    nullptr,
    nullptr
} };
