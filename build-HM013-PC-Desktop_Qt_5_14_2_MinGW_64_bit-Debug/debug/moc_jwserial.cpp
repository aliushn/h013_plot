...
void jwSerial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<jwSerial *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (jwSerial::*)(QString );
...
QT_INIT_METAOBJECT const QMetaObject jwSerial::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_jwSerial.data,
    qt_meta_data_jwSerial,
    qt_static_metacall,
    nullptr,
    nullptr
} };
