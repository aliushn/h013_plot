...
#include <memory>
#include "../../HM013-PC/jwserialthread.h"
...
void jwSerialThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<jwSerialThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (jwSerialThread::*)(QByteArray );
...
QT_INIT_METAOBJECT const QMetaObject jwSerialThread::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_jwSerialThread.data,
    qt_meta_data_jwSerialThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
